...
.. meta::
   :description: The thirty-two 3D mesh and geometry formats polyxios reads and writes, across forty extensions - VTK, OBJ, PLY, STL, glTF, XDMF, Gmsh, ANSYS Fluent, Abaqus, Nastran, Netgen, Kratos MDPA, PERMAS, SVG and more, one reference page each.


polyxios ships thirty-two codecs across forty extensions - the thirty-nine
